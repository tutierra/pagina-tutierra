...
export default function Footer({ contactData, footerData, company_info }: FooterProps) {
  ...
  return (
    <footer className="w-full border-t border-brand-gray/10 bg-brand-ink/60">
      <div className="mx-auto w-[90%] py-[4%] lg:py-[3%]">
        {/* Bloque Principal de 4 Columnas */}
        <div className="grid grid-cols-1 gap-[3em] md:grid-cols-[1.3fr_1fr_1.2fr_1fr]">
          ...
          {/* Columna 3: Contacto (con fallback estático) */}
          <div>
            <h3 className="mb-[1em] text-[0.85rem] tracking-[0.08em] text-tech-green font-semibold uppercase">
              CONTACTO
            </h3>
        ...
        <div className="mt-[3.5em] flex flex-col-reverse items-start justify-between gap-[1em] border-t border-brand-gray/10 pt-[2em] text-[0.8rem] text-brand-gray/50 md:flex-row md:items-center">
